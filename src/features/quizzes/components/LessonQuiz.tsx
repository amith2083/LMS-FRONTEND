...
const Quiz = ({
  ...
  isTaken: boolean;
     ...
     const quizzes = quizSet.quizIds.map((quiz: any) => {
        return {
            id: quiz._id,
		    title: quiz.title,
    ...
    <div className="p-4">
        ...
        variant="outline"
        onClick={() => setOpen(true)} disabled={isTaken}
        >
        <svg
            stroke="currentColor"
            fill="currentColor"
    ...
    <QuizModal quizzes={quizzes} courseId={courseId} quizSetId={quizSet._id} open={open} setOpen={setOpen} />
